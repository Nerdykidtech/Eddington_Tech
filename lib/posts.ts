...
8 thoughts on “FBI Probes Service Selling 153M+ Drivers Licenses”
- 

Love the way you connected the dots to identify the source. Given the companies named, I am probably in that list too.Reply→
- 

What is a safe method to determine if my identity card was compromised in this breach?Reply→
- 

Assume it was.Reply→
- 

Good job everyone  I’m very proud of you  keep up the good workReply→
- 

Great article. Next question/leak: What private/secret information does Real ID  and new Passports contain and how long\, if not already this information is compromised.Reply→
- 
...
IDscan.net sent us the message below on Wed 9/2/2026 12:55 AM UTC. Our company was considering doing business with them. Don’t believe we will be anymore.

Message:
We are writing to inform you of a potential security incident that we are actively investigating.

Our relationship with our customers is extremely important to us, and we wanted you to hear about this directly from us at an early stage, even though our investigation is still preliminary.

Earlier today, September 1, we received information suggesting that certain information may have been exposed and that IDScan.net may be implicated. We are working urgently to validate that information and determine whether any unauthorized access occurred, and the scope of such activity.

Upon learning this information, we immediately initiated our incident response procedures, including:

1. Taking steps to secure potentially affected systems and investigate possible points of access;
2. Notifying our cyber insurance carrier and activating incident response protocols;
3. Engaging outside legal counsel;
4. Beginning the engagement of an independent forensic firm;
5. Coordinating with law enforcement; and
6. Preserving relevant logs and system data.

At this time, we have not reached conclusions regarding the nature or scope of the incident, including what information was involved. However, based on the information available to us at this stage, we believe it is important to notify our clients promptly while we continue our investigation and work to determine the relevant facts.

We are committed to keeping you informed as we learn more. You may reach out toprivacy@idscan.netwith any questions.Reply→
- 

First rule of Fight Club? Same first rule of security, don’t discuss your security, and sure as heck do not allow an identity provider to list you on their website as a customer. Operational security ring a bell?

It’s worth noting that multiple local, state, and federal agencies utilize ID scanning for identity verification — I’m not naming vendors to not muddy the water — and tie your identity back to card data, biometrics, health data, tax data, etc. These platforms, for the most part, are not goverment owned but simply licensed for government and commercial use, and deployments can vary widely depending on the technical acumen of staff, budget, GRC, ethical behavior, etc. So, while it is easy to blame the vendor, you have to take a hard look at each deployed environment (public cloud, private cloud, hybrid, and on-premises) in addition to the software vendors.

Great coverage nonetheless.Reply→`
  }
];
