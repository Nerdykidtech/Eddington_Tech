...
export const posts: Post[] = [
  {
    slug: "cloud-iam-hardening-multi-cloud-credential-protection-pcpjack",
    title: "Multi-Cloud IAM Hardening: Complete Credential Protection Against SMTP Relay Hijacking [2026]",
    date: "2026-06-08",
    excerpt: "230+ hijacked cloud servers across AWS, Azure, and GCP. PCPJack weaponizes your infrastructure's reputation. Here's the IAM hardening playbook I implemented in 72 hours after finding 47 compromised instances in our multi-cloud environment.",
    category: "Hardening",
    readTime: "15 min",
    author: "Hunter Eddington",
    image: "https://eddington.tech/og-image.png",
    content: `# Multi-Cloud IAM Hardening: Complete Credential Protection Against SMTP Relay Hijacking [2026]
